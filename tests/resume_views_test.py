...
class ResumePageViewTest(TestCase):
    ...
    def setUpTestData(cls):
        Summary.objects.create(
            title="Test Resume Title", description="Test Resume Description"
        )
        Projects.objects.create(title="Test Project", description="Test Description")
        ...
        Skill.objects.create(skill="Test Skill")
        Contact.objects.create(
            address="Test Address", email="test@email.com", phone="1231231234"
        )
