...
from resume.models import Summary, Projects, Employment, Education, Skill, Contact, Resume_PDF
...
class EmploymentModelTest(TestCase):
    def test_employment_model(self):
        employment = Employment.objects.create(title='Employment Title', role='Employment Role', location='Employment Location',
                                               start_date='2023-01-01', end_date='2023-12-31', description='Employment Description')
...
class EducationModelTest(TestCase):
    def test_education_model(self):
        education = Education.objects.create(
            title='Education Title', description='Education Description', start_date='2023-01-01', end_date='2023-12-31')
